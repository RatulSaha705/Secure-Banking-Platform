...
const { generateDistinctPrimes } = require('../math/primes');
const { gcd, lcm, bitLength, byteLength, toBigInt } = require('../math/bigint');
const { modInverse } = require('../math/modInverse');
